...
function RainbowCycle({ children, style = {} }) {
  return (
    <span style={{
      ...style,
      // Gradient includes two full rainbow cycles (orange→purple→cyan→yellow→orange, twice)
      // so a 0%→100% shift of a 200% background tiles seamlessly with no jump.
      background: 'linear-gradient(95deg, oklch(0.72 0.28 8), oklch(0.78 0.20 320), oklch(0.82 0.18 200), oklch(0.92 0.18 98), oklch(0.72 0.28 8), oklch(0.78 0.20 320), oklch(0.82 0.18 200), oklch(0.92 0.18 98), oklch(0.72 0.28 8))',
      backgroundSize: '200% 100%',
      WebkitBackgroundClip: 'text', backgroundClip: 'text',
      WebkitTextFillColor: 'transparent', color: 'transparent',
      animation: 'ns-rainbow 3.73s linear infinite',
    }}>{children}</span>
  );
}
